 ...
 * The session configuration derives from the hibernate.hibernate.cfg.xml file in
...
public class HibernateUtil {
    ...
    /**
     * Method builds a session factory from the 'hibernate.hibernate.cfg.xml' file
