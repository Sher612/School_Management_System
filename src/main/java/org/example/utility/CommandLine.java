...
public class CommandLine {
     ...
     * in hibernate.hibernate.cfg.xml <code>hibernate.hbm2ddl.auto = create-drop </code> will create and drop the tables every time the application
     * re-runs.
     *
     *
     */
    public static void addData(){
        ...
        CourseService courseService = new CourseService(sessionFactory);
